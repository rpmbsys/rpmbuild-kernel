...
Source0: https://www.kernel.org/pub/linux/kernel/v5.x/linux-%{rpmversion}.tar.xz
...
#	%%kernel_variant_files [-k vmlinux] <use_vdso> <condition> <subpackage> <without_modules>
#
